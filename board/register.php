...
<body>
    ...
    <nav class="navbar navbar-dark bg-dark navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="./register.php">회원가입</a>
                </li>
            </ul>
    ...
    <div class='login'>
        <form class="form-signin" action='./reg_ck.php' method='post'>
            <div class='form'>
                ...
                <table class='user_menu'>
                    <tr>
                        ...
                        <td style='border-right: 0px'><a href='./login.php'>로그인</a></td>
                    </tr>
                </table>
            </div>
        </form>
